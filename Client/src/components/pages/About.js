    ...
    <div>
      ...
      <div>
        <img
          ...
          src="https://i1.wp.com/csengineermag.com/wp-content/uploads/2020/07/AdobeStock_298001885-2.jpeg?resize=1068%2C500&ssl=1"
          alt="Trulli"
          width="100%"
          height="400"
        />
        ...
        <div className="image-text">
          <h1 className="headings" data-text="About">
            MEET THE PRODUCT
          </h1>
          ...
          <Row className="mt-5">
            <Col ls={12} sm={6}>
              <Container className="left-text">
                ...
                <p>
                  There’s no question about who the biggest fish in the
                  e-commerce sea is; Amazon dominates the marketplace. We built
                  Helium 10 to help everyone capitalize on the Amazon
                  opportunity, from seasoned entrepreneurs to bustling
                  enterprises to anyone who just wants to be their own boss.
                </p>
              </Container>
            </Col>
            ...
            <Col ls={12} sm={6}>
              <Container className="right-image">
                <img
                  src="https://www.helium10.com/app/themes/helium10/assets/img/about-us/about-us_01.svg"
                  width="auto"
                  height="300px"
                />
              </Container>
        ...
        <Row className="mt-5">
          <Col sm={4} md={4} className="col">
            <Card style={{ width: "18rem" }} className="about-card">
              <Card.Body>
                <Card.Title className="icon-design">
          ...
          <Col sm={4} md={4}>
            <Card style={{ width: "18rem" }} className="main-card-team">
              <Card.Img
                ...
                variant="top"
                src="https://images.pexels.com/photos/40997/mona-lisa-leonardo-da-vinci-la-gioconda-oil-painting-40997.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260"
              />
              <Card.Body>
